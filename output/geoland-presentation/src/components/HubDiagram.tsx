  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center">
      ...
      <motion.div 
        ...
        className="relative z-30 w-64 h-64 md:w-80 md:h-80 bg-white/5 backdrop-blur-xl rounded-full border border-white/10 flex items-center justify-center"
      >
            ...
            >
              ...
              >
                ...
                <motion.div 
                  ...
                  className="absolute top-1/2 left-1/2 w-[1px] bg-white origin-center"
                  style={{
                    height: `${radius - 120}px`,
                    transform: `translate(-50%, -50%) rotate(${angle + 90}deg) translateY(-${radius / 2}px)`,
                    opacity: 0.1
                  }}
                />
                ...
                <motion.div
                  ...
                  className="bg-white/5 p-4 rounded-2xl border border-white/10 backdrop-blur-md mb-4"
                >
